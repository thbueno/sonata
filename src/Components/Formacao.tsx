  ...
  return (
    <section className="w-full py-16 px-12 md:px-24 lg:px-56">
      <div className="container mx-auto">
        {/* Title */}
        <h2 className="intersect:motion-preset-blur-down-md motion-duration-1000">
          Formação para
          <br />
          ser e viver
        </h2>
        ...
        {/* Cards Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center intersect:motion-preset-blur-down-lg motion-duration-1500">
