  ...
  return (
    ...
    >
      <div className="container mx-auto w-full flex flex-col items-center gap-12">
        {/* Hero Title */}
        <div className="text-center max-w-4xl px-8 md:px-14 lg:px-12 intersect:motion-preset-blur-down-md motion-duration-1500">
          <h1
            className="
            text-var(--dark-blue)
            leading-tight
        ...
        <div
          ...
          intersect:motion-preset-blur-right motion-duration-1000
        "
        >
          <Image
